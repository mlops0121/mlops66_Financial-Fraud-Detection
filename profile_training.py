...
from src.utils.profiling import Timer, profile_training
...
def main():
    ...
    parser.add_argument('--dry-run', action='store_true',
                        help='Quick test without full training')
    parser.add_argument('--output', type=str, default='logs/profile_stats.prof',
